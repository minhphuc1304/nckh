...
class AA_kernel(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.conv0 = Conv(in_channel, out_channel, kSize=1,stride=1,padding=0) # ảnh xám
        self.conv1 = Conv(out_channel, out_channel, kSize=(3, 3),stride = 1, padding=1) # tích chập 3x3 
